...
class Player17(player16.Player16, threading.Thread):
    ...
    def predictKickCommand(self, i):
        ...
        if command.startswith("(kick"):
            ...
            ball_rad = math.atan2(self.m_dBallY[i] - self.m_dY[i], self.m_dBallX - self.m_dY)
        ...
        self.m_dBallX[next] = self.m_dBallX[i] + self.m_dBallVX[i] + self.m_dBallAX
        self.m_dBallY[next] = self.m_dBallY[i] + self.m_dBallVY[i] + self.m_dBallAY
